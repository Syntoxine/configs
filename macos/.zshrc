...
# FFMPEG scripts
alias tiktok-dl='sh ~/Public/TikTok/download-convert.sh'
alias vertical-blur='sh ~/Public/TikTok/vertical-blur.sh'

# Minecraft scripts
alias mc-server-status='sh ~/Games/active-server.sh'
